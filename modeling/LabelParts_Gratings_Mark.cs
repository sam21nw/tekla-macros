...
namespace Tekla.Technology.Akit.UserScript
{
  public class Script
  {
    ...
    private const string PickPrompt = "Pick all parts to label gratings...";
    ...
    //private static readonly Color TextColor = new Color(1.00, 0.38, 0.51); // cyan
    ...
    //private static readonly Color TextColor = new Color(0.59, 0.96, 0.74); // greenish cyan
		...
		public static void RunMacro(IScript akit)
		{
			...
			while (pickedObjects.MoveNext())
			{
				...
				if(part.GetPartMark().Contains("GR") || part.GetPartMark().Contains("CG")){
